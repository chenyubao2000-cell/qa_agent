...
| `i18nMessagesDir` | `I18N_MESSAGES_DIR` from .env | Path to i18n message JSON files relative to sourceProjectDir (e.g., "apps/mira-work/i18n/messages"). Used for i18n key reverse-lookup during POM generation |
