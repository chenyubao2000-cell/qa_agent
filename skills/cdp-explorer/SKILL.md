...
### Step 3 — Form Exploration (Discover Input Constraints)
...
### Step 4 — State Stability Detection
...
### Step 5 — State Equivalence Check
...
|-----------|-------------|
| **Coverage saturation** | 10 consecutive interactions discovered no new states or elements (all interactions lead to known states) |
| **Queue empty** | Priority queue is empty, all interactive elements have been processed |
