...
## 8-12. Common Scenarios, Configuration, Best Practices, Anti-Patterns, Debugging

For common code patterns (navigation, dialogs, file upload, iframe, network interception, dropdowns), configuration requirements, best practices, anti-patterns, and debugging commands, read `references/patterns-config.md`.
...
- `references/patterns-config.md` — Common scenarios (navigation, dialogs, file upload, iframe, network), configuration, best practices, anti-patterns, debugging commands.
