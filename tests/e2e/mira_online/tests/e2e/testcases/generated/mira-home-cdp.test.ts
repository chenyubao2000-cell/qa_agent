...
test.describe("[CDP] Mira Homepage", () => {
  test(
    "TC-CDP-HOME-001 首页核心功能展示完整：Hero + 核心 tab + 功能卡片 + 底部 CTA",
    { tag: ["@P2", "@full"] },
    async ({ page, i18n }) => {
      ...
      await expect(home.getHeroCtaLink()).toHaveAttribute(
        "href",
        "/join-waitlist",
      );
      ...
      await expect(home.getCoreFeatureHeading("workWithYou")).toHaveText(
        i18nRegex("homepage.features.coreFeatures.workWithYou.title"),
      );
      await expect(home.getCoreFeatureHeading("trainedByYou")).toBeVisible();
      await expect(home.getCoreFeatureHeading("trainedByYou")).toHaveText(
        i18nRegex("homepage.features.coreFeatures.trainedByYou.title"),
      );
      await expect(home.getCoreFeatureHeading("topTierModels")).toBeVisible();
      await expect(home.getCoreFeatureHeading("topTierModels")).toHaveText(
        i18nRegex("homepage.features.coreFeatures.topTierModels.title"),
      );
      await expect(home.getCoreFeatureHeading("integratedTools")).toBeVisible();
      await expect(home.getCoreFeatureHeading("integratedTools")).toHaveText(
        i18nRegex("homepage.features.coreFeatures.integratedTools.title"),
      );

      // Bottom CTA
      await expect(home.getBottomCtaHeading()).toBeVisible();
      await expect(home.getBottomCtaHeading()).toHaveText(
  ...
  test(
    'TC-CDP-HOME-002 导航"登录"链接跳转到 /task',
  ...
  test(
    'TC-CDP-HOME-003 Hero CTA"加入等待名单"跳转到 /join-waitlist',
...
test.describe("[CDP] Mira Homepage — Feature Tabs", () => {
  test(
    'TC-CDP-HOME-004 点击"招聘"tab 切换显示招聘功能卡片',
    { tag: ["@P1", "@regression", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
      ...
      await expect(
        home.getRecruitingFeatureHeading("candidateData"),
      ).toBeVisible();
      await expect(
        home.getRecruitingFeatureHeading("candidateData"),
      ).toHaveText(
        i18nRegex("homepage.features.recruitingFeatures.candidateData.title"),
      );
      await expect(
        home.getRecruitingFeatureHeading("communication"),
      ).toBeVisible();
      await expect(
        home.getRecruitingFeatureHeading("communication"),
      ).toHaveText(
        i18nRegex("homepage.features.recruitingFeatures.communication.title"),
      );
      await expect(
        home.getRecruitingFeatureHeading("recruitingSkills"),
      ).toBeVisible();
      await expect(
        home.getRecruitingFeatureHeading("recruitingSkills"),
      ).toHaveText(
      ...
      await expect(
        home.getRecruitingFeatureHeading("securityTrust"),
      ).toBeVisible();
      await expect(
        home.getRecruitingFeatureHeading("securityTrust"),
      ).toHaveText(
        i18nRegex("homepage.features.recruitingFeatures.securityTrust.title"),
      );
    },
  );

  test(
    'TC-CDP-HOME-005 点击"核心"tab 切换显示核心功能卡片',
    { tag: ["@P1", "@regression", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
  ...
  test(
    "TC-CDP-HOME-009 Tab 切换 round-trip：核心→招聘→核心",
    { tag: ["@P2", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
...
test.describe("[CDP] Mira Homepage — Language Selector", () => {
  test(
    "TC-CDP-HOME-006 语言切换：中文→英文，验证文本 i18n 正确",
    { tag: ["@P1", "@regression", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
      ...
      if (targetLang === "English") {
        ...
        await expect(home.getRecruitingTabByIndex()).toContainText(
          "Recruiting",
        );
        await expect(
          page.getByRole("heading", { name: "Request Early Access" }),
        ).toBeVisible();
      } else {
        ...
        await expect(
          page.getByRole("heading", { name: "申请抢先体验" }),
        ).toBeVisible();
      }
    },
  );
  ...
  test(
    "TC-CDP-HOME-010 语言切换 round-trip：中文→英文→中文",
    { tag: ["@P2", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
      ...
      await expect(home.getNavSignInLinkByHref()).toContainText(
  ...
  test(
    "TC-CDP-HOME-011 语言切换后 tab 状态保持",
    { tag: ["@P2", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
      ...
      if (isZh) {
        await expect(
          page.getByRole("heading", { name: "Candidate Data" }),
        ).toBeVisible();
      } else {
        await expect(
          page.getByRole("heading", { name: "候选人数据获取" }),
        ).toBeVisible();
      }
    },
  );
...
test.describe("[CDP] Mira Homepage — Navigation Links", () => {
  test(
    'TC-CDP-HOME-007 底部 CTA"加入等待名单"跳转到 /task',
    { tag: ["@P1", "@regression", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
  ...
  test(
    'TC-CDP-HOME-008 导航"加入等待名单"链接跳转到 /join-waitlist',
    { tag: ["@P1", "@regression", "@full"] },
    async ({ page, i18n }) => {
      const home = new MiraHomePage(page, i18n);
      await home.goto();
